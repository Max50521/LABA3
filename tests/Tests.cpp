...
Test->insert_node({"Максим", "Космынин", "Б20-524" });
Test->insert_node({"Никита", "Косенко", "Б20-524" });
Test->insert_node({"Кирилл", "Иванов", "Б20-514" });
ASSERT_EQ(3, Test->height());
...
Test->delete_node(Test->find_node(Test->get_root(), {"Кирилл", "Иванов", "Б20-514" }));
ASSERT_TRUE(Test->check_element({"Кирилл", "Иванов", "Б20-514" }) == false);
Test->insert_node({"Кирилл", "Иванов", "Б20-514" });
}
